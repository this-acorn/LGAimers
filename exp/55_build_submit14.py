# -*- coding: utf-8 -*-
"""
[55] artifacts/submissions/submit14.zip 빌드+검증 — 타겟분해 멀티클래스 CS79 CatBoost 8시드
...
SRC = f"{ROOT}/submissions/submit14_src"
OUT_ZIP = f"{ROOT}/artifacts/submissions/submit14.zip"
...
log("=" * 80)
log("A. artifacts/submissions/submit14.zip 생성 및 구조 검사")
log("=" * 80)
