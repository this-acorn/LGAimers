...
ap.add_argument("--out-dir", default='submissions/submit17_src', help="번들 저장 폴더 (model/model.pkl). 프로브마다 다른 폴더를 주면 챔피언 번들과 충돌 없음")
args = ap.parse_args()
ARM = args.arm.upper()
...
spec = importlib.util.spec_from_file_location("s17", 'submissions/submit17_src/script.py')
