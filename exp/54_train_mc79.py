# -*- coding: utf-8 -*-
"""
[54] 멀티클래스 분해 배포 학습 — CS79 피처 + 5클래스 타겟, CatBoost MultiClass 8시드
...
build_matrix, CS_FEATS, PT_FEATS = s14.build_matrix, s14.CS_FEATS, s14.PT_FEATS
P_RATES, B_RATES, PFB_IN, CAT = s14.P_RATES, s14.B_RATES, s14.PFB_IN, s14.CAT
...
X5 = s14.build_matrix(ft5, b2["feats"])
