# -*- coding: utf-8 -*-
"""
[66] 멀티클래스 + lr 튜닝 — exp/65에서 확증된 lr0.04를 챔피언에 적용
...
기준: mc5 lr0.08 2시드 = 837.0 (exp/53). lr만 0.04로 낮춘 효과 측정.
...
np.save("lab/66_mc_lr04.npy", ens.astype("float32"))
sc = raw_score(ens, y_va)
log("\n" + "=" * 70)
log(f"판정: mc5 lr0.04 = {sc:.1f}  (mc5 lr0.08 837.0 대비 {sc-837.0:+.1f} / 이진 {s_ref:.1f} 대비 {sc-s_ref:+.1f})")
